...
[![Codacy Badge](https://api.codacy.com/project/badge/grade/960364d8c953408185251ec749de5b80)](https://www.codacy.com/app/voostindie/magisto)
...
Magisto [comes as a ZIP](http://search.maven.org/remotecontent?filepath=nl/ulso/magisto/magisto/1.1.0/magisto-1.1.0.zip) that you have to unpack. In the `bin` directory you'll find scripts for your favorite OS. (Note: I don't use Windows myself, so I couldn't test that particular script.)
